...
inline Dnum operator+(Dnum l, Dnum r) {
  return Dnum(l.f() + r.f(), l.d() + r.d());
}
inline Dnum operator-(Dnum l, Dnum r) {
  return Dnum(l.f() - r.f(), l.d() - r.d());
}
inline Dnum operator*(Dnum l, Dnum r) {
  return Dnum(l.f() * r.f(), l.f() * r.d() + l.d() * r.f());
}
inline Dnum operator/(Dnum l, Dnum r) {
  return Dnum(l.f() / r.f(), (l.d() * r.f() - l.f() * r.d()) / r.f() / r.f());
}
...
inline Dnum Pow(Dnum g, float n) {
